...
[desktop store release validation matrix](store-release-validation.md). A completed
...
Existing listing identities must be reused because changing extension IDs strands browser-local data. Current listing copy, permissions, reviewer instructions, screenshots, and support/privacy links live under [store-assets](store-assets/README.md).
