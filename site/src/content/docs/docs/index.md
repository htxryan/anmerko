---
title: Overview
description: Turn website comments and screenshots into a clear brief for your AI agent.
---

anmerko is a browser extension that turns website comments and screenshots into a clear brief for your AI agent. Point to what should change and describe it; anmerko includes the page URL and captured context with your feedback. Comments and screenshots are saved locally in your browser. No account or API key is needed.
...
5. Give the prompt to your AI agent. If your feedback includes screenshots, attach the exported image files separately; **Copy Prompt** includes their filenames but does not attach them.
