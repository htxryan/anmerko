...
- `journeys.md`, with every step in full: its action, timing, full URLs, target details, entered values, screenshot filename, and markers for anything you edited, removed, redacted, or masked, followed by **Limitations**, which notes losses such as shortened entered values
